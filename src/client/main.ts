...
import { labeler, Label, Anchor } from './labeler';

const labels: Label[] = [
  new Proxy({x: 40, y: 40, widht: 50, height: 50, name: 'Node 1'}, {
    // set: function(obj, prop, value) {
    //   console.log(obj, prop, value);
    //   return Reflect.set(obj, prop, value);
    // }
  }),
  new Proxy({x: 45, y: 45, widht: 50, height: 50, name: 'Node 1'}, {
    // set: function(obj, prop, value) {
    //   console.log(obj, prop, value);
    //   return Reflect.set(obj, prop, value);
    // }
  }),
  new Proxy({x: 47, y: 47, widht: 50, height: 50, name: 'Node 1'}, {
    // set: function(obj, prop, value) {
    //   console.log(obj, prop, value);
    //   return Reflect.set(obj, prop, value);
    // }
